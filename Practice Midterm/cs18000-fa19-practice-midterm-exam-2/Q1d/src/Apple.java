public class Apple implements Food, Consumable{
	/**
	 * The calories of this apple.
	 */
	private final int calories;
	/**
	 * The carbohydrates of this apple.
	 */
	private final int carbs;
	/**
	 * The protein of this apple.
	 */
	private final int protein;
	/**
	 * The fats of this apple.
	 */
	private final int fats;
	/**
	 * The allergens of this apple.
	 */
	private final String[] allergens;
	/**
	 * The {@code Apple} constructor will take in four {@code int}s representing calorie count, carbohydrates,
	 ...
	 */
	public Apple(int calories, int carbs, int protein, int fats, String[] allergens) {
	 ...
	 * <p>
	 * Birch Pollen, Tree Pollen, Fruit Seed
	 *
